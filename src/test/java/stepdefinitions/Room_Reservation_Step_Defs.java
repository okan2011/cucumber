...
//    =======click on hotelmanagement, room reservation, addroom reservation
    ...
    public void user_enters_the_date_start() {
        roomReservationPage.dateStart.sendKeys("07/01/2022");
    }
    @Given("user enters the date_end")
    public void user_enters_the_date_end() {
        roomReservationPage.dateEnd.sendKeys("07/05/2022");
    }
    ...
    public void user_verifies_the_success_message() {
        ReusableMethods.waitForVisibility(roomReservationPage.actualSuccessMessage,15);
...
//WE USED DATA TABLE BELOW
    @Given("user enters all required fields")
    public void user_enters_all_required_fields(DataTable roomData) throws IOException {
       ...
       @Then("capture the screenshot")
        public void capture_the_screenshot() throws IOException {
           ReusableMethods.getScreenshot("Take the screenshot");
       }
