...
//        Go to the next row
        ...
        //GO TO THE LAST COLUMN USING last() method. firs() takes to the first column.
    ...
    public void user_gets_the_value_in_row_in_column_and_verifies_the_value_is(Integer rowNum, String column, String value) {
