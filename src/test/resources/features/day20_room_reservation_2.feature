...
Feature: User_should_be_able_to_reserve_room
  ...
  Scenario Outline: TC_01_login_with_manager_profile
    ...
    Examples: test data
      ...
      |manager   |Manager1!       |manager        |manager|Sierra|1000  |07/01/2022|07/03/2022| 2          |3              |test        |(546) 345-6345  |test@gmail.com |test               |RoomReservation was inserted successfully  |
#      |manager   |Manager1!       |manager        |manager|Krystel|250  |07/01/2022|08/01/2022|         6  |0              |My Boss     |(999) 345-6345 |alone@gmail.com|Don't bother       |RoomReservation was inserted successfully  |
#      |manager   |Manager1!       |manager        |manager|Karelle|100  |07/01/2022|07/02/2022|2           |1              |My Boss     |(999) 345-6345 |both@gmail.com |one day reservation|RoomReservation was inserted successfully  |